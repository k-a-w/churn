...
from churn_Spring2025.entity.artifact_entity import ModelPusherArtifact,\
        ModelEvaluationArtifact
from churn_Spring2025.entity.config_entity import ModelPusherConfig
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.telco_estimator = TelcoEstimator(bucket_name=model_pusher_config.bucket_name,
